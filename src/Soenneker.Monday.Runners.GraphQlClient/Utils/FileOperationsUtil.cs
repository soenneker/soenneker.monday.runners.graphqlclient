...
using Soenneker.Monday.Runners.GraphQlClient.Utils.Abstract;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string mondayToken = EnvironmentUtil.GetVariableStrict("MONDAY__TOKEN");
        ...
        string result = await _graphQlDownloadUtil.Download("https://api.monday.com/v2", headers, cancellationToken: cancellationToken);
        ...
        var graphQlGeneratorConfig = new GeneratorConfig
        {
            Namespace = Constants.Library,
            OutputDirectory = srcDirectory,
            EntryClientName = "MondayGraphQlClient"
        };
